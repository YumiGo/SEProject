    ...
    public class MyWebViewClient extends WebViewClient {
        ...
        Response.Listener<String> readyResponse = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                String url = element.getAsJsonObject().get("next_redirect_pc_url").getAsString();
        ...
        StringRequest readyRequest = new StringRequest(Request.Method.POST, "https://kapi.kakao.com/v1/payment/ready", readyResponse, errorListener) {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("partner_user_id", "user"); // 가맹점 회원 아이디
                ...
                params.put("approval_url", "https://developers.kakao.com/success"); // 결제 성공시 돌려 받을 url 주소
                params.put("cancel_url", "https://developers.kakao.com/cancel"); // 결제 취소시 돌려 받을 url 주소
                params.put("fail_url", "https://developers.kakao.com/fail"); // 결제 실패시 돌려 받을 url 주소
                return params;
            }
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("Authorization", "KakaoAK " + "f425a897e1e3fa6afbeb62ac57e4abc6");
                return headers;
            }
        };
        ...
        StringRequest approvalRequest = new StringRequest(Request.Method.POST, "https://kapi.kakao.com/v1/payment/approve", approvalResponse, errorListener) {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("partner_user_id", "user");
